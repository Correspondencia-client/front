...
// Estilos básicos
const linkStyles =
  "inline-flex items-center gap-1 rounded-full px-3 py-1 text-sm font-medium transition-colors hover:bg-gray-100 dark:hover:bg-gray-800";
const buttonStyles = {
  primary:
...
function NavItem({ label, href, sublinks }: NavLink) {
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-1 w-48 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg py-1 z-50">
...
export function MobileMenu({
  ...
  return (
    <div className="lg:hidden">
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 py-2">
